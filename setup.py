...
setuptools.setup(
    ...
    # description_content_type='text/markdown; charset=UTF-8; variant=GFM',  # Optional (see note above)
    ...
    #
    packages=setuptools.find_packages(exclude=['main.py', 'test_cpp', 'test_cu', 'test_rs']),  # Required
